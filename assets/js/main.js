(function ($) {
	...
	windowOn.on("scroll", function () {
		windowOn.scrollTop() > 300 ? backToTopWrapper.addClass("back-to-top-btn-show") : backToTopWrapper.removeClass("back-to-top-btn-show");
	});
	...
	windowOn.on("scroll", function () {
		...
		scrollTop < 20 ? $("#header-sticky").removeClass("header-sticky") : $("#header-sticky").addClass("header-sticky");
	});
	...
	var testimonialSlider = new Swiper(".tp-testimonail-active", {
		...
		pagination: {
			...
			renderFraction: function (currentClass, totalClass) {
				return '<span class="' + currentClass + '"></span>' + '<span class="tp-testimonail-dvdr tp-testimonail-progress"></span>' + '<span class="' + totalClass + '"></span>';
			},
