							...
							function e(t, o) {
								...
								[].forEach.call(d, function (e) {
									e.addEventListener("click", function (t) {
										...
										var o = e.dataset.videoId,
											n = e.dataset.channel || u.channel,
											l = (0, r.getUniqId)(),
											a = e.dataset.videoUrl || i.getVideoUrl(u, n, o),
											d = i.getHtml(u, a, l);
										(0, r.append)(c, d);
							...
							return (
								i(e, [
									...
									},
									{
										...
										value: function (e, t, o) {
											var n = e.split(":"),
												i = Number(n[0]),
												r = Number(n[1]);
											return t < o * (r / i) ? Math.floor((i / r) * t) + "px" : "100%";
										}
									},
									{
										key: "getQueryString",
									...
									},
									{
										...
										value: function (e, t, o) {
											return "youtube" === t
												...
												: "facebook" === t
												? this.getFacebookUrl(e.facebook, o)
												: "custom" === t
												? e.url
												: "";
										}
									...
									},
									{
										key: "getYoutubeUrl",
										value: function (e, t) {
											var o = this.getQueryString(e);
											return !0 === e.nocookie ? "//www.youtube-nocookie.com/embed/" + t + "?" + o : "//www.youtube.com/embed/" + t + "?" + o;
										}
									},
									{
										key: "getFacebookUrl",
			...
			5: [
				function (e, t, o) {
					...
					(o.append = function (e, t) {
						...
						for (o.innerHTML = t; o.children.length > 0; ) e.appendChild(o.children[0]);
					}),
						...
						(o.triggerEvent = function (e, t, o) {
							var n = void 0;
							window.CustomEvent ? (n = new CustomEvent(t, { cancelable: !0 })) : ((n = document.createEvent("CustomEvent")), n.initCustomEvent(t, !1, !1, o)), e.dispatchEvent(n);
						});
				},
				{}
			]
